...
Cassette is a Julia package that provides a just-in-time (JIT) pass injection mechanism, or
**overdubbing mechanism**, that interleaves external context-specific code transformations
